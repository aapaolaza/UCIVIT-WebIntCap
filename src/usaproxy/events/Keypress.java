...
//	}
	...
	/** Deserialise given JSON and creates a Keypress element with the result
	 * @param serialised class in JSON
	 */
	
	public Keypress (String json){
		this(new Gson().fromJson(json, Keypress.class));
	}
	
	public Keypress (Keypress tempClass){
		super(tempClass);
	...
	public static Keypress parseFromHash(EventDataHashMap eventData) {
		...
		return new Keypress(eventData);
	}
	
	private Keypress(EventDataHashMap eventData) {
		super(eventData);
