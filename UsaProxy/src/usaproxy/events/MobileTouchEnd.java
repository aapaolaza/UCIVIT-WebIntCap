...
/**
 * Event triggered when the user using a mobile device removes a touch from the screen with one or more fingers.
 * 
 */
public class MobileTouchEnd extends GenericEvent{

	/**
	 * Empty constructor
	 */
	public MobileTouchEnd(){
		super();
	...
	/** Deserialise given JSON and creates a MobileTouchEnd element with the result
	 * @param serialised class in JSON
	 */

	public MobileTouchEnd(String json){
		this(new Gson().fromJson(json, MobileTouchEnd.class));

	}
	
	public MobileTouchEnd (MobileTouchEnd tempClass){
		super(tempClass);
	 ...
	 * 
	 */
	public static MobileTouchEnd parseFromHash(EventDataHashMap eventData) {

		return new MobileTouchEnd(eventData);

	}
	
	private MobileTouchEnd(EventDataHashMap eventData) {
		super(eventData);
